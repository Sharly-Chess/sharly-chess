...
- Correction de l'affichage des points lors de l'édition des appariements via l'interface d'administration (2.8.4)
...
- Fixed the point display when editing pairings via the admin interface (2.8.4)
