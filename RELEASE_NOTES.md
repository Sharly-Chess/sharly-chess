...
- Network spectators can now open screens, rotators, and display controllers by clicking anywhere on their card or list row when viewing is the only available action (5.0.3)
