...
def calls(monkeypatch):
    ...
    monkeypatch.setattr('web.remote_access_api.requests.post', post)
...
def test_nothing_is_sent_while_nobody_is_signed_in(monkeypatch):
    ...
    monkeypatch.setattr(
        'web.remote_access_api.requests.post',
...
def test_a_control_plane_that_cannot_be_reached_says_so(calls, monkeypatch):
    ...
    monkeypatch.setattr('web.remote_access_api.requests.post', refuse)
