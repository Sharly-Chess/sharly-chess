...
from data.access_levels.access_levels import ScreenManagementAccessLevel
...
@pytest.mark.e2e
class TestScreenManagerAccessLevel(BaseAccessLevelTest):
    def get_access_levels(self):
        return [ScreenManagementAccessLevel]
