...
from data.access_levels.access_levels import ResultsEntryAccessLevel
...
@pytest.mark.e2e
class TestResultsEntryAccessLevel(BaseAccessLevelTest):
    def get_access_levels(self):
        return [ResultsEntryAccessLevel]
    ...
    def test_access(
        ...
        super().assert_can_enter_results_via_screen(True, False, False)
