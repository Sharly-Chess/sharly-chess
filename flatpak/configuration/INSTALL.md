...
Sharly Chess requires the GNOME Platform version 48. While Flatpak usually handles dependencies automatically, installing them explicitly can prevent issues.
...
### "Runtime not found"
If you see an error indicating a missing runtime (e.g., `org.gnome.Platform/x86_64/48`), ensure you have added the Flathub remote and run the runtime installation step above.
