...
The workflow `.github/workflows/publish-multiarch.yml` handles the build process.
...
- **FLATPAK_CI_CD_BUILD_INTEGRATION_SUMMARY.md** - CI/CD overview
- **SETUP_FLATPAK_CI_CD_PIPELINE.md** - CI/CD setup guide
...
Sharly Chess stores data in the application's private data directory, using version-specific folders to ensure data isolation:

```
~/.var/app/com.sharlychess.SharlyChess/data/sharly-chess-X.Y.Z/
├── events/              # Configuration (.scc), Tournaments (.sce) and Archives
├── logs/                # Application logs
├── tmp/                 # Temporary files and Databases (FIDE, FFE)
└── custom/              # User custom files
```

**Data persists across:**
- Application restarts
- Flatpak updates (new versions create new folders)
- System reboots
