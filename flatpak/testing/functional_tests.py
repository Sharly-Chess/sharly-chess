...
class FlatpakTestSuite:
    ...
    def __init__(self, flatpak_dir: Path):
        ...
        self.manifest_path = flatpak_dir / 'configuration' / 'com.sharlychess.SharlyChess.json'
        self.manifest: Dict = {}
    ...
    def test_network_permission(self) -> Tuple[bool, str]:
        ...
        return True, '⚠ Network permission not explicitly set (may be OK for GUI-only app)'
    ...
    def test_appdata_file_exists(self) -> Tuple[bool, str]:
        ...
        appdata_file = self.flatpak_dir / 'configuration' / 'com.sharlychess.SharlyChess.appdata.xml'
    ...
    def test_desktop_file_exists(self) -> Tuple[bool, str]:
        ...
        desktop_file = self.flatpak_dir / 'configuration' / 'com.sharlychess.SharlyChess.desktop'
