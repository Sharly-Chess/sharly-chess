...
| `FFE_HOSTNAME` | FFE SQL server host | Provided by the Sharly Chess team |
| `FFE_USER` | FFE SQL user | Provided by the Sharly Chess team |
| `FFE_PASSWORD` | FFE SQL password | Provided by the Sharly Chess team |
| `FFE_DATABASE` | FFE database name | Provided by the Sharly Chess team |
