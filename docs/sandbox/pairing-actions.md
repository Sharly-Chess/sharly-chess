...
|-----------------------|:---------------------------------------------:|:-------------------------------------------------:|:--------------------------------------------:|:--------------------------------------------:|:---------------------------------------------:|
| Total Pairing         | :no_entry_sign: :white_circle: :white_circle: |   :no_entry_sign: :white_circle: :white_circle:   | :white_circle: :white_circle: :white_circle: |      :white_check_mark: :ok: :pushpin:       | :no_entry_sign: :white_circle: :white_circle: |
...
| Player swap           |      :no_entry_sign: :warning: :pushpin:      |   :white_check_mark: :grey_question: :pushpin:    | :white_check_mark: :grey_question: :pushpin: | :white_circle: :white_circle: :white_circle: | :white_circle: :white_circle: :white_circle:  |
