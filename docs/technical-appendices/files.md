...
| `bin\ffe.bat`                    | Script            | Windows batch | The script of the _FFE_ plugin                                                                                |
| `bin\chessevent.bat`             | Script            | Windows batch | The script of the _ChessEvent_ plugin                                                                         |
| `bin\bbpPairings\*`              | Library           | Windows EXE   | The bbpPairings library used for Swiss pairing                                                                |
