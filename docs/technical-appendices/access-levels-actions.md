_Do not edit this table manually, use script generate_access_levels_doc.py instead._

| Actions / Access levels                      |     |     |     |    |     |     |     |     |     |     |   |
|:---------------------------------------------|:---:|:---:|:---:|:--:|:---:|:---:|:---:|:---:|:---:|:---:|:-:|
| Application                                  | ADM | ORG | SCR | CA | DCA | PAI | SEC | CHE | RES | SPE | - |
| Manage application settings                  |  ✔  |  -  |  -  | -  |  -  |  -  |  -  |  -  |  -  |  -  | - |
| Manage source databases                      |  ✔  |  -  |  -  | -  |  -  |  -  |  -  |  -  |  -  |  -  | - |
| Manage archives                              |  ✔  |  -  |  -  | -  |  -  |  -  |  -  |  -  |  -  |  -  | - |
| Events                                       | ADM | ORG | SCR | CA | DCA | PAI | SEC | CHE | RES | SPE | - |
...
| Tournaments                                  | ADM | ORG | SCR | CA | DCA | PAI | SEC | CHE | RES | SPE | - |
...
| View Prizes tab                              |  ✔  |  -  |  -  | ✔  |  ✔  |  -  |  -  |  -  |  -  |  -  | - |
| Manage prizes                                |  ✔  |  -  |  -  | ✔  |  ✔  |  -  |  -  |  -  |  -  |  -  | - |
| Documents                                    | ADM | ORG | SCR | CA | DCA | PAI | SEC | CHE | RES | SPE | - |
| Generate documents                           |  ✔  |  -  |  -  | ✔  |  ✔  |  -  |  -  |  -  |  -  |  -  | - |

(*) Knowing the list of the currents events is needed to select the events before authenticating.

_Generated by script generate_access_levels_doc.py on 2026-05-02 18:18_
