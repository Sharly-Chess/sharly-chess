...
| `chessevent_last_sync`                    | `FLOAT`   |                                            | chessevent   | The date of the last synchronization with the ChessEvent platform                                                                                          |
| `chessevent_status`                       | `TEXT`    |                                            | chessevent   | The status of the ChessEvent synchronzation                                                                                                                |
