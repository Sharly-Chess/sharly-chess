...
| `update_password`          | `TEXT`    |                           |            | The password to provide to use the entry screens                                                                                                                                                                         |
...
| `players_show_unpaired`  | `INTEGER` |                                            |     | Boolean:<br/>- `NULL` if `type` is different from `players`;<br/>- `0`: unmatched players are hidden;<br/>- `0`: unmatched players are shown                                                                      |
...
| `input_exit_button`     | `INTEGER` |                                            |     | Boolean:<br/>- `NULL` if `type` is different from `input`;<br/>- `1`: a button to exit the page is displayed;<br/>- `0`: the button is not displayed                                                                             |
| `players_show_unpaired` | `INTEGER` |                                            |     | Boolean:<br/>- `NULL` if `type` is different from `players`;<br/>- `0`: unpaired players are hidden;<br/>- `0`: unpaired players are shown                                                                                       |
| `first`                 | `INTEGER` |                                            |     | The number of the first element (board or player) to consider                                                                                                                                                                    |
| `last`                  | `INTEGER` |                                            |     | The number of the last element (board or player) to consider                                                                                                                                                                     |
