# Configuration et Test du Build sur chess2

Guide complet pour configurer et tester le build automatique avec les scripts d'initialisation sur https://github.com/GillesHorn/chess2
...
### 2. Script d'Initialisation Unifié
...
- Procédure via interface web GitHub
- Installation via GitHub CLI
- Vérification et dépannage
- Best practices de sécurité

## 🚀 Étapes de Mise en Place sur chess2

### Étape 1 : Copier les Fichiers

Depuis votre `sharly-chess` local vers le repository `chess2` :
...
git add init-credentials.py
git add docs/technical-appendices/GITHUB_SECRETS_CONFIGURATION.md
...
1. Aller sur https://github.com/GillesHorn/chess2/settings/secrets/actions
...
1. Aller sur https://github.com/GillesHorn/chess2/actions
...
| `GITHUB_SECRETS_CONFIGURATION.md` | `docs/technical-appendices/` | Guide configuration secrets |

## ✅ Checklist de Mise en Place

- [ ] Copier `.github/workflows/build-test-with-init.yml`
- [ ] Copier `init-credentials.py`
- [ ] Copier `GITHUB_SECRETS_CONFIGURATION.md`
- [ ] Commit et push vers chess2
...
- Secrets: Voir `GITHUB_SECRETS_CONFIGURATION.md`
