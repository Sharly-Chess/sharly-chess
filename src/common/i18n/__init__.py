...
if DEVEL_ENV and not TEST_ENV and not Path(sys.argv[0]).stem == 'i18n_update':
    ...
    if _auto_update_file.is_file():
        ...
        BabelUpdater(locale_infos, DEFAULT_LOCALE, generate_doc=False)
    else:
...
def update_i18n_files(generate_doc: bool) -> bool:
    ...
    return BabelUpdater(locale_infos, DEFAULT_LOCALE, generate_doc=generate_doc).ok
