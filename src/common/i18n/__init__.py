...
if DEVEL_ENV:
    ...
    elif not sys.argv[0].startswith('i18n_update'):
        # if i18n_update is running then update_i18n_files() will be called later,
        # no need to update the MO files here
        BabelMOFilesUpdater(locales)


def update_i18n_files(generate_doc: bool):
    ...
    if not _auto_update_file.is_file():
        BabelUpdater(locale_infos, DEFAULT_LOCALE, generate_doc)
