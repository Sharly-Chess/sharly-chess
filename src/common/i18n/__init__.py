...
def get_i18n_domain() -> str:
    """Walk the live Python frame chain (no linecache / posix.stat) to find
    the first non-i18n, non-jinja2 caller and resolve its plugin domain."""
    import sys

    frame = sys._getframe(1)  # skip get_i18n_domain itself
