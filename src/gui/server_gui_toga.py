...
class SharlyChessServerToga(toga.App):
    ...
    def __init__(
        ...
        self.remote_access_button: toga.Button | None = None
    ...
    def _on_remote_access_account_change(self) -> None:
    ...
    def _report_remote_access_stopped(self) -> None:
    ...
    async def _show_remote_access_stopped(self, reason: str) -> None:
        assert isinstance(self.main_window, toga.Window)
    ...
    def _on_remote_access_press(self, widget: toga.Button, **kwargs: Any) -> None:
    ...
    def _add_remote_access_section(self) -> None:
        ...
        if url:
            ...
            address = toga.Box(style=Pack(direction=ROW, align_items='center', gap=10))
    ...
    def _on_remote_access_toggle(self, widget: toga.Button, **kwargs: Any) -> None:
    ...
    def _start_remote_access(self, take_over: bool = False) -> None:
        self._work_at_remote_access(
            _('Making this server reachable…'),
            lambda: start_remote_access(take_over=take_over),
        )

    async def _on_remote_access_new_url(
        self, widget: toga.Button, **kwargs: Any
    ) -> None:
    ...
    def _on_remote_access_take_over(self, widget: toga.Button, **kwargs: Any) -> None:
    ...
    def _work_at_remote_access(self, waiting: str, work: Callable[[], object]) -> None:
