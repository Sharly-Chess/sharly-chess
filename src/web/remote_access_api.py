...
def _post(path: str, body: dict[str, Any]) -> dict[str, Any]:
    ...
    if code == 'retired':
        raise AddressRetiredError('This address was given up in favour of a new one.')
...
def send_heartbeat(
    remote_uniq_id: str, install_id: str, name: str | None = None
) -> str:
    ...
    return str(data['instance_nonce'])
