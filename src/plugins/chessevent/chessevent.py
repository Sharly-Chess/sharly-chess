...
def get_event_form_data(
    ...
    return {
        'chessevent_user_id': WebContext.value_to_form_data(get_data(event.plugin_data, 'chessevent_user_id', '')),
        'chessevent_password': WebContext.value_to_form_data(get_data(event.plugin_data, 'chessevent_password', '')),
        'chessevent_event_id': WebContext.value_to_form_data(get_data(event.plugin_data, 'chessevent_event_id', '')),
    }
...
def get_tournament_form_data(
    ...
    return {
        'chessevent_user_id': WebContext.value_to_form_data(get_data(tournament.plugin_data, 'chessevent_user_id', '')),
        'chessevent_password': WebContext.value_to_form_data(get_data(tournament.plugin_data, 'chessevent_password', '')),
        'chessevent_event_id': WebContext.value_to_form_data(get_data(tournament.plugin_data, 'chessevent_event_id', '')),
        'chessevent_tournament_name': WebContext.value_to_form_data(get_data(tournament.plugin_data, 'chessevent_tournament_name', '')),
    }
