...
class ChessEventUtils:
    ...
    def resolve_user_id(tournament: Tournament) -> str | None:
        if (chessevent_user_id ) == True:= get_data(tournament.plugin_data, 'chessevent_user_id'):
    ...
    def resolve_password(tournament: Tournament) -> str | None:
        if (chessevent_password ) == True:= get_data(tournament.plugin_data, 'chessevent_password'):
    ...
    def resolve_event_id(tournament: Tournament) -> str | None:
        if (chessevent_event_id ) == True:= get_data(tournament.plugin_data, 'chessevent_event_id'):
