...
class Snapshot:
    ...
    def _replace_event_file(self, event_file: Path) -> None:
    ...
    def _publish_event_restored(self) -> None:
...
def archive_snapshots(uniq_id: str, archive_stem: str) -> None:
...
def rename_snapshots(uniq_id: str, new_uniq_id: str) -> None:
...
def restore_archived_snapshots(archive_stem: str, uniq_id: str) -> None:
...
def delete_archived_snapshots(archive_stem: str) -> None:
...
class SnapshotRetention:
    ...
    @classmethod
    def apply_to_event(cls, uniq_id: str) -> None:
    ...
    @classmethod
    def _prune(cls, snapshots: list[Snapshot]) -> None:
        for snapshot in snapshots:
            try:
    ...
    @classmethod
    def _remove_leftovers(cls) -> None:
    ...
    @classmethod
    def _enforce_total_size(cls) -> None:
