...
class SupportsRemote(Protocol):
    """Anything that says whether it may be reached from outside the venue."""
...
class Client:
    ...
    def reachable[T: SupportsRemote](self, entities: Sequence[T]) -> list[T]:
        ...
        return [entity for entity in entities if entity.remote]
