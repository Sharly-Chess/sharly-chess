...
class SnapshotScheduler:
    ...
    @classmethod
    def notify_changed(cls, uniq_id: str) -> None:
    ...
    @classmethod
    def _cancel_pending(cls, uniq_id: str) -> None:
        with _state.lock:
    ...
    @classmethod
    def _on_idle(cls, uniq_id: str) -> None:
    ...
    @classmethod
    def _apply_retention(cls, uniq_id: str) -> None:
        try:
    ...
    @classmethod
    def _record_success(cls, uniq_id: str) -> None:
        with _state.lock:
    ...
    @classmethod
    def _record_failure(cls, uniq_id: str, exception: SnapshotException) -> None:
        with _state.lock:
            status = _state.statuses.setdefault(uniq_id, SnapshotStatus())
    ...
    @classmethod
    def _report(cls, uniq_id: str, exception: SnapshotException) -> None:
    ...
    @staticmethod
    def publish_snapshot_failed(uniq_id: str) -> None:
